define(["jquery", "text!./PLSmartPivot.css"], function (e, t) {
    ...
    return e("<style>").html(t).appendTo("head"), {
        ...
        paint : function (t, a) {
            ...
            var vDimName = "";
            var CustomArray = [];
            var CustomArrayBasic = [];
            var vNumCustomHeaders = 0;
            var ConceptMatrix = [];
            var ConceptMatrixFirst = [];
            var ConceptMatrixRowElem = [];
            var ConceptMatrixSecond = [];
            var ConceptMatrixColElem = [];
            var ConceptMatrixColElemTable = [];
            var ConceptMatrixPivot = [];
            var ArrayGetSelectedCount = [];
            var ConceptMatrixFirstClean = [];
            var vColumnText = "";
            var vColumnNum = "";
            var vPercent = false;
            var vMaskNum = 0;
            ...
            if (vNumDims == 2) {
                ...
                for (var nPivotElems = 0;nPivotElems <= lastrow;nPivotElems++) {
                    ConceptMatrixPivot[nPivotElems] = [];
